...
public static class GetById
{
    ...
    public static IEndpointRouteBuilder MapGetById(this IEndpointRouteBuilder app)
    {
        ...
        {
            var flashSet = await repository.GetByIdForUser(flashSetId, context.GetUserId(), cancellationToken);
            ...
            var response = new FlashSetsGetGetByIdResponse(flashSet.Id, flashSet.CreatorId, flashSet.Name, flashSet.FlashCards);
